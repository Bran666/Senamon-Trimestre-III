...
class Senamones {
  ...
  // Senamones(this.nombre, this.nivel, this.tipo, this.salud, this.ataque, this.fase, this.energia, this.descripcion, this.senamones);

void asignarAleatorios(){
  for (int i = 0; i < senamones.length; i++) {
    senamones[i][3] = Random().nextInt(91) + 10;   
    senamones[i][4] = Random().nextInt(31) + 30; 
    senamones[i][5] = Random().nextInt(31) + 20; 
    senamones[i][7] = Random().nextInt(51) + 50; 
  }
}

  void returnSenamones (){
...
void main() {
  var senamones = Senamones();

  senamones.asignarAleatorios();

  senamones.returnSenamones();

  senamones.returnFuego();
  senamones.returnAgua();
  senamones.returnHierva();
  senamones.returnElectrico();
  senamones.returnVolador();
}
